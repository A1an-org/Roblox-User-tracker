...
module.exports = {
    name: "slap",
    description: "slap the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/slap";
        try {
        ...
        const embed = new MessageEmbed()
            .setTitle(`slap a person`)
            .setColor(`#f3f3f3`)
            .setDescription(`${message.author.username} slapged ${user.username}!`)
