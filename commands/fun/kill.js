...
module.exports = {
    name: "kill",
    description: "kill the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/kill";
        try {
        ...
        if (!user) return message.channel.send('Oh oh... you gotta provide a valid user to killed :/');

        const embed = new MessageEmbed()
            .setTitle(`Fucked a person`)
            .setColor(`#f3f3f3`)
