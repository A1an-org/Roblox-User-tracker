...
module.exports = {
    name: "kiss",
    description: "kiss the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/kiss";
        try {
        ...
        if (!user) return message.channel.send('Oh oh... you gotta provide a valid user to kisseed :/');

        const embed = new MessageEmbed()
            .setTitle(`Kissed a person`)
            .setColor(`#f3f3f3`)
            .setDescription(`${message.author.username} kisseed ${user.username}!`)
