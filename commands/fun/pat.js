...
module.exports = {
    name: "pat",
    description: "pat the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/pat";
        try {
        ...
        if (!user) return message.channel.send('Oh oh... you gotta provide a valid user to pat :/');

        const embed = new MessageEmbed()
            .setTitle(`pat a person`)
            .setColor(`#f3f3f3`)
            .setDescription(`${message.author.username} patged ${user.username}!`)
