...
module.exports = {
    name: "bite",
    description: "bite the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/bite";
        try {
        ...
        if (!user) return message.channel.send('Oh oh... you gotta provide a valid user to bite :/');

        const embed = new MessageEmbed()
            .setTitle(`bite a person`)
            .setColor(`#f3f3f3`)
            .setDescription(`${message.author.username} biteged ${user.username}!`)
