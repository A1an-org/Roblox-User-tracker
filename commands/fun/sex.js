...
module.exports = {
    name: "sex",
    description: "sex the person your married to.",
    category: "Fun",
    usage: ["sex <@>"],
    aliases: [],
    cooldown: 3,
    run: async (bot, message, args) => {
        ...
        const urle = "https://yuabot.com/weeb/api/v1/img/lick";
        try {
        ...
        if (!user) return message.channel.send('Oh oh... you gotta provide a valid user to fuck :/');
