...
module.exports = {
    ...
    run: async (bot, message, args) => {
      ...
      .setTitle(module.exports.name || "Null")      
        ...
        if (!args[0]) return message.channel.send(sembed3)
        ...
        if (!mutee) return message.channel.send(sembed3);
        ...
        if (!mutee.roles.cache.has(muterole.id)) return message.channel.send(sembed3)
        try {
